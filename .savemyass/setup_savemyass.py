...
def install_dependencies(pip_cmd):
    ...
    uninstalled_dependency = check_dependencies()
...
if __name__ == "__main__":
    try:
        ...
        base_dir = os.path.dirname(os.path.abspath(__file__)); venv_path = os.path.join(base_dir, '.savemyass/venv' if os.path.exists(os.path.join(base_dir, '.savemyass')) else 'venv')
